...
const rangeData: Record<Range, any[]> = {
  Daily: consumptionDaily,
  Monthly: consumptionMonthly,
  Yearly: consumptionYearly,
};
...
const Consumption = () => {
  ...
  const avgTotal = actuals.reduce((s: number, d: any) => s + d[avgKey], 0);
