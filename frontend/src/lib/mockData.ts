...
export const consumptionDaily = [
  { label: "Mon", consumption: 12.4, cost: 4.1, co2: 2.7, avg: 14.5, kind: "actual" as const },
  { label: "Tue", consumption: 11.8, cost: 3.9, co2: 2.5, avg: 14.5, kind: "actual" as const },
  { label: "Wed", consumption: 15.6, cost: 5.2, co2: 3.4, avg: 14.5, kind: "actual" as const },
  { label: "Thu", consumption: 13.1, cost: 4.4, co2: 2.9, avg: 14.5, kind: "actual" as const },
  { label: "Fri", consumption: 14.9, cost: 5.0, co2: 3.2, avg: 14.5, kind: "actual" as const },
  { label: "Sat", consumption: 16.3, cost: 5.6, co2: 3.6, avg: 14.5, kind: "actual" as const },
  { label: "Sun", consumption: 14.2, cost: 4.85, co2: 3.1, avg: 14.5, kind: "actual" as const },
  // Forecast — predicted by the model (next 3 days)
  { label: "Mon+", consumption: 13.1, cost: 4.4, co2: 2.8, avg: 14.5, kind: "forecast" as const },
  { label: "Tue+", consumption: 12.4, cost: 4.2, co2: 2.7, avg: 14.5, kind: "forecast" as const },
  { label: "Wed+", consumption: 11.8, cost: 4.0, co2: 2.6, avg: 14.5, kind: "forecast" as const },
];

// Monthly series: 6 actual + 2 forecast months (aligned to end in Dec 2020)
export const consumptionMonthly = [
  { label: "Jul", consumption: 172, cost: 58, co2: 38, avg: 230, kind: "actual" as const },
  { label: "Aug", consumption: 165, cost: 55, co2: 36, avg: 220, kind: "actual" as const },
  { label: "Sep", consumption: 218, cost: 74, co2: 49, avg: 280, kind: "actual" as const },
  { label: "Oct", consumption: 286, cost: 96, co2: 64, avg: 320, kind: "actual" as const },
  { label: "Nov", consumption: 412, cost: 138, co2: 92, avg: 460, kind: "actual" as const },
  { label: "Dec", consumption: 498, cost: 168, co2: 110, avg: 510, kind: "actual" as const },
  { label: "Jan*", consumption: 521, cost: 176, co2: 118, avg: 540, kind: "forecast" as const },
  { label: "Feb*", consumption: 467, cost: 158, co2: 104, avg: 490, kind: "forecast" as const },
];

// Yearly series: 4 actual + 1 forecast
export const consumptionYearly = [
  { label: "2017", consumption: 4820, cost: 1620, co2: 1080, avg: 5200, kind: "actual" as const },
  { label: "2018", consumption: 4510, cost: 1580, co2: 1010, avg: 5050, kind: "actual" as const },
  { label: "2019", consumption: 4180, cost: 1520, co2: 940, avg: 4900, kind: "actual" as const },
  { label: "2020", consumption: 3920, cost: 1465, co2: 880, avg: 4750, kind: "actual" as const },
  { label: "2021*", consumption: 3680, cost: 1380, co2: 820, avg: 4600, kind: "forecast" as const },
];
